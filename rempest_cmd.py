...
# instructions:
# need the python source file (this file!)
# need the data source file
# need the model source file
...
# We only care abotu the coulumn names
...
# rf = pd.read_pickle("random_forest_model.pkl")
oneprice = rf.predict(onehouse)
# print(f'${oneprice:.2f}')
print(oneprice)